...
public class MyRandomDemo {	
	...
	// but limit it between 0 and MAXPICK	
	pickOne = randomGen.nextInt(MAXPICK + 1);	
	pickTwo = randomGen.nextInt(MAXPICK + 1);	
	pickThree = randomGen.nextInt(MAXPICK + 1);	
	pickFour = randomGen.nextInt(MAXPICK + 1);
        pickFive = randomGen.nextInt(MAXPICK + 1);
	pickBonus = randomGen.nextInt(MAXBONUS + 1);
